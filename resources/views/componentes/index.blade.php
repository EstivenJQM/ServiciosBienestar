<x-layout title="Componentes">
    ...
    {{-- Búsqueda --}}
    <form method="GET" action="{{ route('componentes.index') }}" class="mb-3">
        <div class="d-flex flex-wrap gap-2 align-items-end">
            <div class="input-group" style="max-width:400px">
                ...
                <input type="text" name="busqueda" value="{{ $busqueda }}"
                       class="form-control"
                       placeholder="Nombre de componente o área…">
            </div>
                                    ...
                                    <div class="collapse mt-1 ms-3" id="{{ $lineaId }}">
                                        @forelse($linea->tiposActividad as $tipo)
                                            <div class="d-flex align-items-center gap-2 py-1 px-2 rounded mb-1"
                                                 style="background-color:#edfff0">
                                                <i class="bi bi-tag-fill" style="color:#65FE74;font-size:.75rem"></i>
